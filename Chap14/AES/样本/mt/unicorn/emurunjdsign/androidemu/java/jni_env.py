...
class JNIEnv:
    ...
    def add_local_reference(self, obj):
        ...
        logger.debug("add_local_reference %s" % obj.__class__)
    ...
    def set_local_reference(self, idx, newobj):
        ...
        logger.debug("set_local_reference %s" % newobj.__class__)
        self._locals.set(idx, newobj)

    def get_local_reference(self, idx):
        r = self._locals.get(idx)
        logger.debug("get_local_reference %s" % r.__class__)
        return r
    ...
    def new_global_ref(self, mu, env, obj):
        ...
        rc = self.add_global_reference(obj)
        logger.debug("JNIEnv->NewGlobalRef rc = %d" % rc)
        return rc
