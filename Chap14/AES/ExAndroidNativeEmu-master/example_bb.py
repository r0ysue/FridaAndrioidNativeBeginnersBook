...
class DexInstall(metaclass=JavaClassDef, jvm_name='com/SecShell/SecShell/DexInstall'):
    ...
    #
    @staticmethod
    @java_method_def(name='install', args_list=["jobject", "jstring", "jstring"],
                     signature='(Ljava/lang/ClassLoader;Ljava/lang/String;Ljava/lang/String;)V', native=False)
...
class DexInstallV26(metaclass=JavaClassDef, jvm_name='com/SecShell/SecShell/DexInstall$V26'):
    ...
    @staticmethod
    @java_method_def(name='install', args_list=["jobject", "jstring"],
                     signature='(Ljava/lang/ClassLoader;Ljava/lang/String;)V', native=False)
