...
public class MainActivity extends AppCompatActivity {
    ...
    //.init  .init_arrary , so feature   = dlopen dlsym
...
//        tv.setText(decrypt("82e8edd5b05654bf0fedcdfc1c9b4b0f") +" "+ Build.BRAND +" "+ Build.DEVICE);
//        new Thread(){
//            @Override
//            public void run() {
//                //需要在子线程中处理的逻辑
...
//                    Log.i("roysueSIGN",Sign("requestUserInfo"));
//
//                }
//            }
//        }.start();
