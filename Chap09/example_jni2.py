...
try:
    ...
    logger.info("Response from JNI call: %s" % emulator.call_symbol(lib_module,"Java_com_roysue_easyso1_MainActivity_method01",emulator.java_vm.jni_env.address_ptr, 0x00, String('r0ysue')))
    for i in range (1,5):
        logger.info("Response from JNI call: %s" % emulator.call_symbol(lib_module,"_Z8method02P7_JNIEnvP7_jclassP8_jstring",emulator.java_vm.jni_env.address_ptr, 0x00, String('4e8de2f3c674d8157b4862e50954d81c')))
        time.sleep(2)
